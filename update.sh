...
case $VERSION in
    ...
    "base4")
        if [ "$REVERSE" = true ]; then
            ...
            cp streaming_llm/pos_shift/modify_qwen_base4.py streaming_llm/pos_shift/modify_qwen.py
            ...
            cp streaming_llm/pos_shift/modify_qwen.py streaming_llm/pos_shift/modify_qwen_base4.py
