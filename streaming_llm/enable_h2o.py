from streaming_llm.kv_cache import H2OKVCache_LayerWise


def enable_streaming_llm(model, start_size, recent_size, hh_size):
    if "llama" in model.config.model_type:
        ...
        k_seq_dim = v_seq_dim = 2
        from streaming_llm.pos_shift.modify_qwen import (
